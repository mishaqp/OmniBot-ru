...
class LegacyTextLocalizer {
  ...
  static final Map<String, String> _exactRu = <String, String>{
    ...
    '小万': 'Omnibot',
    '小万（OmniAi）': 'OmniAi',
    '默认的桌面悬浮窗宠物': 'Питомец для плавающего окна по умолчанию',
    '自定义宠物': 'Пользовательский питомец',
    '已选': 'Выбрано',
    '选择': 'Выбрать',
    '刷新': 'Обновить',
    ...
    '导入 Codex 宠物包': 'Импортировать пакет питомца Codex',
    '上传压缩包': 'Загрузить пакет',
    '宠物已导入并选中': 'Питомец импортирован и выбран',
    '导入宠物失败': 'Не удалось импортировать питомца',
    '收起宠物失败': 'Не удалось скрыть питомца',
    '唤起宠物失败，请确认悬浮窗权限已开启':
        'Не удалось показать питомца. Проверьте разрешение на отображение поверх окон',
    '设置': 'Настройки',
    '外观设置': 'Внешний вид',
    '主题模式': 'Тема',
    ...
    'Alpine 环境': 'Среда терминала',
    '终端环境': 'Среда терминала',
    ...
    '未连接': 'Не подключено',
    '已复制': 'Скопировано',
    '后台隐藏': 'Скрывать из списка последних',
    '闹钟设置': 'Настройки будильника',
    '首页设置': 'Настройки главной страницы',
    '新对话': 'Новый чат',
    '默认': 'По умолчанию',
    '关于小万': 'О приложении Omnibot',
    '背景来源': 'Источник фона',
    '效果预览': 'Предпросмотр',
    '效果调整': 'Настройки',
    '聊天': 'Чат',
    '工作区': 'Рабочая область',
    '启用背景图': 'Использовать фоновое изображение',
    ...
    '悬浮窗权限': 'Разрешение на отображение поверх окон',
    '应用列表读取权限': 'Доступ к списку приложений',
    'Shizuku 权限': 'Разрешение Shizuku',
    '公共文件访问': 'Доступ к общим файлам',
