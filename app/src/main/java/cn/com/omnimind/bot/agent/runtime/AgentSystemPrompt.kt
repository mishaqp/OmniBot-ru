    ...
    fun build(
        ...
        return when (locale) {
            ...
            PromptLocale.RU_RU -> """
                ...
                - Если задача содержит два и более независимых параллельных потока либо чётко ограниченную подзадачу исследования, планирования или упорядочивания памяти, используй sub-Agent/параллельное выполнение без ожидания отдельной просьбы пользователя.
